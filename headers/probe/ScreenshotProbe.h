...
public:
    ...
    virtual void debug_probe_feature_layers(const ScreenshotData &data, std::vector<std::pair<std::string, std::vector<Coords>>> &res) = 0;
    [[nodiscard]] ProbeResult get_probe_result() const { return probe_result; }
protected:
